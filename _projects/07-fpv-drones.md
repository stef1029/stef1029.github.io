...
description: Designing and building custom FPV drones end to end, from component selection through assembly and tuning to client delivery.
# img: assets/img/projects/drone-thumb.jpg   # ← uncomment once the file exists
importance: 1
category: personal
...
{% include todo.liquid text="Soldering and wiring discipline, PID tuning, RF and video-link troubleshooting, and working to someone else's requirements and deadline. <strong>Make the through-line to the research hardware explicit</strong> — it's the same skill set that later let you take a rig from concept to manufactured PCB in weeks, and saying so turns a hobby into evidence." %}

## Links

{% include todo.liquid text="Link build logs, a gallery or a forum profile if any survive. Delete this section entirely if nothing does — an empty Links heading looks worse than no heading." %}
